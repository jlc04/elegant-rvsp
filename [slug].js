// /api/events/:slug
// GET    -> full event record (used by builder, guest view, and dashboard)
// PUT    -> update event fields (name/date/venue/theme/questions/status)
// DELETE -> remove an event and its responses
...
export async function onRequestPut({ params, request, env }) {
  ...
  const next = {
    ...
    status: body.status ?? event.status, // 'draft' | 'published'
